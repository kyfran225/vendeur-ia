...
/**
 * The subset of the mapbox-gl [Map](https://docs.mapbox.com/mapbox-gl-js/api/map/)
 * API that search-js interacts with.
 *
 * Since v3, mapbox-gl ships two structurally-identical but nominally-distinct `Map` types.
 */
export interface MapInstance {
    ...
    getZoom(): number;
    flyTo(options: mapboxgl.FlyToOptions): unknown;
    cameraForBounds(bounds: mapboxgl.LngLatBoundsLike): unknown;
}
/**
