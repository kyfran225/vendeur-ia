...
# 1. Conteneur d'arrière-plan arrondi : GRIS PLATINE (#cbd5e1 = 203, 213, 225)
canvas = Image.new('RGBA', (h, w), (203, 213, 225, 255))
mask_bg = Image.new('L', (h, w), 0)
draw = ImageDraw.Draw(mask_bg)
draw.rounded_rectangle([(0, 0), (w, h)], radius=260, fill=255)

# 2. Branche Gauche : BLANC PUR (#ffffff) & Branche Droite : VERT ÉMERAUDE (#10b981)
...
# Composite logo over platinum gray tile
...
print('Saved Platinum Tile + White/Emerald logo icons successfully!')
