...
export function PaymentProofAuditorModal({ isOpen, onClose }: PaymentProofAuditorModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex flex-col justify-start sm:justify-center items-center p-0 sm:p-4 bg-slate-950/60 dark:bg-black/80 backdrop-blur-md animate-in fade-in">
      <div className="bg-slate-50 dark:bg-[#0c1612] border-0 sm:border border-slate-200/90 dark:border-white/10 w-full max-w-4xl h-full sm:h-auto sm:max-h-[90vh] rounded-none sm:rounded-3xl flex flex-col shadow-2xl overflow-hidden animate-in slide-in-from-bottom duration-300 text-slate-900 dark:text-white supports-[height:100dvh]:h-[100dvh] sm:supports-[height:100dvh]:h-auto">
