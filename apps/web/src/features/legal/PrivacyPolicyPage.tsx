  ...
  return (
    <div className="min-h-[100dvh] bg-slate-50 dark:bg-vendeur-coal text-slate-900 dark:text-slate-100 flex flex-col selection:bg-vendeur-emerald selection:text-black transition-colors duration-200">
      <MetaHead
        ...
        canonicalUrl={`${SITE_CONFIG.baseUrl}/privacy`}
        keywords={['politique de confidentialité vendeur ia', 'rgpd vendeuria', 'protection données meta whatsapp']}
      />
          ...
          <div className="space-y-8 text-slate-700 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3 flex items-center gap-2">
                <CheckCircle2 className="text-emerald-600 dark:text-vendeur-emerald" size={20} />
                1. Présentation et Éditeur du Service
              </h2>
              <p>
                Le service <strong>Vendeur IA</strong> (accessible à l'adresse{" "}
                <code className="text-emerald-700 dark:text-vendeur-emerald bg-slate-100 dark:bg-white/5 px-2 py-0.5 rounded">https://vendeuria.maatfeed.com</code>)
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-slate-600 dark:text-slate-400 pl-2">
                <li><strong className="text-slate-900 dark:text-slate-200">Informations de compte marchand :</strong> Nom, prénom, adresse e-mail, nom de la boutique, numéro de téléphone.</li>
                <li><strong className="text-slate-900 dark:text-slate-200">Données issues des plateformes Meta (WhatsApp Cloud API, Instagram Graph API, Messenger API) :</strong> Identifiants d'utilisateur final (numéro WhatsApp, identifiant Instagram/Messenger), contenus des conversations échangées avec l'agent IA, préférences d'achat.</li>
                <li><strong className="text-slate-900 dark:text-slate-200">Données de transaction et commandes :</strong> Produits consultés, paniers d'achat, historiques de paiement (ex: Mobile Money, Paystack), adresses de livraison.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="mt-3 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-4 text-xs text-slate-700 dark:text-slate-300">
            ...
            <section>
              ...
              <div className="mt-3 bg-slate-50 dark:bg-slate-800/80 border border-emerald-500/30 rounded-xl p-4">
                <p className="font-semibold text-emerald-700 dark:text-vendeur-emerald mb-1">Procédure de suppression :</p>
                <p className="text-xs text-slate-700 dark:text-slate-300 leading-relaxed">
                  - Via l'interface de l'application : visitez la page dédiée de suppression des données à l'adresse <code className="text-emerald-700 dark:text-white font-mono">https://vendeuria.maatfeed.com/data-deletion</code>.<br/>
                  - Par e-mail : envoyez une demande à <a href="mailto:vendeuria@gmail.com" className="text-emerald-600 dark:text-vendeur-emerald font-semibold underline">vendeuria@gmail.com</a> avec l'objet "Demande de suppression de données Meta". Nous traiterons votre demande sous 48 heures ouvrées.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-slate-700 dark:text-slate-300">
                ...
                - <strong>Site Web :</strong> <a href="https://vendeuria.maatfeed.com" className="text-emerald-600 dark:text-vendeur-emerald font-semibold hover:underline">https://vendeuria.maatfeed.com</a><br />
                - <strong>E-mail :</strong> <a href="mailto:vendeuria@gmail.com" className="text-emerald-600 dark:text-vendeur-emerald font-semibold hover:underline">vendeuria@gmail.com</a>
              </p>
            </section>
          </div>
        </div>
