...
/**
 * `MapboxSearchBox` is a class that lets you search for places, addresses, and landmarks using
 ...
 * You can also pass it to a [Mapbox GL JS](https://docs.mapbox.com/mapbox-gl-js/guides/) map
 * via `map.addControl()` to zoom to selected results; `MapboxSearchBox` implements the
 * [IControl](https://www.mapbox.com/mapbox-gl-js/api/markers/#icontrol) interface.
 *
...
export declare class MapboxSearchBox extends HTMLScopedElement<SearchEventTypes> implements mapboxgl.IControl {
     ...
     * ```
     */
    bindMap(map: MapInstance | null): void;
    /**
