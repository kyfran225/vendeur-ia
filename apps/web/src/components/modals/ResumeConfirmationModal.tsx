    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative w-full max-w-md max-h-[85vh] overflow-y-auto bg-white dark:bg-[#0e161b] border border-slate-200 dark:border-emerald-500/30 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-2xl text-slate-900 dark:text-white z-10 my-auto"
        >
          {/* Subtle Ambient Glow */}
          <div className="absolute top-0 right-0 w-48 h-48 sm:w-64 sm:h-64 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none -mr-20 -mt-20" />
          ...
          <div className="flex flex-col items-center text-center space-y-1.5 sm:space-y-2.5 pt-1 sm:pt-2">
            <div className="h-11 w-11 sm:h-14 sm:w-14 rounded-xl sm:rounded-2xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center text-emerald-600 dark:text-vendeur-emerald shadow-md sm:shadow-lg shadow-emerald-500/20">
              <PlayCircle className="w-6 h-6 sm:w-8 sm:h-8" />
            </div>

            <div className="space-y-1">
              <span className="inline-block px-2.5 py-0.5 rounded-full text-[9px] sm:text-[10px] font-black uppercase tracking-widest bg-emerald-500/15 text-emerald-700 dark:text-vendeur-emerald border border-emerald-500/30">
          ...
          <div className="my-3 sm:my-5 space-y-2 sm:space-y-2.5 bg-slate-50 dark:bg-black/40 border border-slate-200/80 dark:border-white/5 p-3 sm:p-4 rounded-xl sm:rounded-2xl">
            <div className="flex items-start gap-2.5 sm:gap-3 text-left">
              ...
              <p className="text-[11px] sm:text-xs text-slate-600 dark:text-white/80 leading-tight sm:leading-relaxed font-medium">
                <strong className="text-slate-900 dark:text-white">Réponses instantanées :</strong> L'IA répondra immédiatement à tous vos clients sur WhatsApp.
              </p>
            </div>
            ...
            <div className="flex items-start gap-2.5 sm:gap-3 text-left">
              ...
              <p className="text-[11px] sm:text-xs text-slate-600 dark:text-white/80 leading-tight sm:leading-relaxed font-medium">
                <strong className="text-slate-900 dark:text-white">Présentation & Commandes :</strong> Présentation du catalogue et encaissement automatiques.
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="w-full sm:flex-1 h-10 sm:h-11 rounded-lg sm:rounded-xl bg-vendeur-emerald hover:bg-emerald-400 text-slate-950 text-[11px] sm:text-xs font-black uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20 active:scale-95 cursor-pointer order-1 sm:order-2"
            >
