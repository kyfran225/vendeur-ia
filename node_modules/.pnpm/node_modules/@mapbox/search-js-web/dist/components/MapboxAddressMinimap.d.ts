 ...
 *
 * Instantiating it produces a DOM element that you append into any container;
 * set the `feature` property to display a marker for that location.
 *
 ...
 * Set the token directly on the instance via `accessToken`, set it globally via
 * [`config.accessToken`](/api/web/config/#config), or — when used inside a
 * [`confirmAddress()`](/api/web/autofill/#confirmaddress) call — let the
 * confirmation dialog pass its token through automatically.
 *
