 ...
 *
 * Calling `SessionToken` will return an `id` with a [UUIDv4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) value. If you want to manage the token `id` yourself, you
 * can pass your value into `SessionToken` (a UUIDv4 value is recommended).
 *
 * Any method that accepts a `SessionToken` object as an argument or option
