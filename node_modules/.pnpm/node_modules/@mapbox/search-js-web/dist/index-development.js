...
var _popover, _binding, _labelID, _resultListID, _inputInternal, _searchService, _selectedIndexInternal, _showResults, showResults_fn, _renderResultsList, renderResultsList_fn, _themeInternal, _popoverOptions, _handleInput, _handleSelect, _handleFocus, _handleBlur, _handleFocusOut, _handleKeyDown;
var MapboxSearchListbox = class extends HTMLScopedElement {
  constructor() {
    ...
    __privateAdd(this, _handleFocusOut, (event) => {
      if (!__privateGet(this, _binding).MapboxSearch.contains(event.relatedTarget)) {
        this.hideResults();
      }
    });
    this.handleArrowUp = () => {
  ...
  connectedCallback() {
    ...
    Results.addEventListener("focusout", __privateGet(this, _handleFocusOut));
  ...
  disconnectedCallback() {
    this.input = null;
    const { Results } = __privateGet(this, _binding);
    Results.removeEventListener("focusout", __privateGet(this, _handleFocusOut));
    if (__privateGet(this, _popover))
      __privateGet(this, _popover).destroy();
  }
  focus() {
...
// src/components/MapboxAddressAutofill.ts
var _autofill, _session, _input, _listbox, _eventManager, _initialAutocompleteValue, _browserAutofillEnabled, _handleSuggest, _handleSuggestError, _handleRetrieve, _handleObserve, _observer, _handleBrowserAutofill, _onHandleInput, _onHandleSelect, _onHandleBlur, _onHandleInputBlur, _onHandleFocus, _handleClear;
  ...
  constructor() {
    ...
    __privateAdd(this, _handleObserve, () => {
      ...
      try {
        ...
        if (input) {
          input.addEventListener("blur", __privateGet(this, _onHandleInputBlur));
        }
      } catch (e) {
    ...
    __privateAdd(this, _onHandleInputBlur, (event) => {
      if (!__privateGet(this, _listbox).contains(event.relatedTarget)) {
        __privateGet(this, _onHandleBlur).call(this);
...
_onHandleInputBlur = new WeakMap();
...
var _binding5, _search, _session2, _map, _input2, _listbox2, _eventManager2, _componentOptions, _getCoreComponentOptions, _getDefaultPlaceholder, getDefaultPlaceholder_fn, _placeholder, _handleSuggest2, _handleSuggestError2, _handleRetrieve2, _mapMarker, _removeMarker, _handleMarker, _onHandleInput2, _onHandleSelect2, _onHandleBlur2, _onHandleFocusOut, _setActionIcons, _handleClear2, _handleMoveEnd, _fly;
var MapboxSearchBox = class extends HTMLScopedElement {
  constructor() {
    ...
    this.options = {};
    __privateAdd(this, _componentOptions, __spreadValues({}, DEFAULT_COMPONENT_OPTIONS));
    __privateAdd(this, _getCoreComponentOptions, () => {
      const options = __spreadValues({}, this.componentOptions);
    ...
    __privateAdd(this, _handleSuggest2, (result) => __async(this, null, function* () {
      ...
      __privateGet(this, _listbox2).handleSuggest(suggestions || null);
      if (!__privateGet(this, _binding5).SearchBox.contains(document.activeElement)) {
        this.focus();
      }
      this.dispatchEvent(new MapboxHTMLEvent("suggest", result));
    }));
    __privateAdd(this, _handleSuggestError2, (error) => __async(this, null, function* () {
      __privateGet(this, _setActionIcons).call(this);
      if (this.componentOptions.customSearch) {
        const customFeatures = yield this.componentOptions.customSearch(this.value);
        if (customFeatures && customFeatures.length) {
          ...
          __privateGet(this, _listbox2).handleSuggest(customFeatures || null);
        } else {
    ...
    __privateAdd(this, _handleRetrieve2, (result) => {
      ...
      if (this.componentOptions.flyTo) {
        __privateGet(this, _fly).call(this, feature);
      }
    ...
    __privateAdd(this, _onHandleInput2, (e) => {
      ...
      __privateGet(this, _session2).suggest(searchText, __spreadValues(__spreadValues({}, this.options), __privateGet(this, _getCoreComponentOptions).call(this)));
    ...
    __privateAdd(this, _onHandleFocusOut, (event) => {
      if (!__privateGet(this, _binding5).SearchBox.contains(event.relatedTarget) && !__privateGet(this, _listbox2).contains(event.relatedTarget)) {
        __privateGet(this, _onHandleBlur2).call(this);
        __privateGet(this, _listbox2).hideResults();
        this.dispatchEvent(new MapboxHTMLEvent("blur"));
      }
    });
    ...
    __privateAdd(this, _fly, (feature) => {
      const map = __privateGet(this, _map);
      if (!map) {
        return;
      }
      ...
      if (bounds) {
        flyToOptions = bboxViewport(map, import_search_js_core9.LngLatBounds.convert(bounds).toFlatArray());
      } else {
  ...
  get componentOptions() {
    return __privateGet(this, _componentOptions);
  }
  set componentOptions(options) {
    __privateSet(this, _componentOptions, __spreadValues(__spreadValues({}, DEFAULT_COMPONENT_OPTIONS), options));
  }
  get theme() {
  ...
  connectedCallback() {
    ...
    const { Input, ClearBtn, SearchBox } = __privateGet(this, _binding5);
    SearchBox.addEventListener("focusout", __privateGet(this, _onHandleFocusOut));
  ...
  disconnectedCallback() {
    const { SearchBox } = __privateGet(this, _binding5);
    SearchBox.removeEventListener("focusout", __privateGet(this, _onHandleFocusOut));
...
_componentOptions = new WeakMap();
_getCoreComponentOptions = new WeakMap();
...
var _binding6, _search2, _session3, _map2, _input3, _listbox3, _eventManager3, _componentOptions2, _getCoreComponentOptions2, _getDefaultPlaceholder2, getDefaultPlaceholder_fn2, _placeholder2, _handleSuggest3, _handleSuggestError3, _handleRetrieve3, _mapMarker2, _removeMarker2, _handleMarker2, _onHandleInput3, _onHandleSelect3, _onHandleBlur3, _onHandleFocusOut2, _setActionIcons2, _handleClear3, _handleMoveEnd2, _fly2;
var MapboxGeocoder = class extends HTMLScopedElement {
  constructor() {
    ...
    this.options = {};
    __privateAdd(this, _componentOptions2, __spreadValues({}, DEFAULT_COMPONENT_OPTIONS2));
    __privateAdd(this, _getCoreComponentOptions2, () => {
      const options = __spreadValues({}, this.componentOptions);
      for (const key in options) {
    ...
    __privateAdd(this, _handleSuggest3, (result) => __async(this, null, function* () {
      ...
      __privateGet(this, _listbox3).handleSuggest(features || null);
      if (!__privateGet(this, _binding6).Geocoder.contains(document.activeElement)) {
        this.focus();
      }
      this.dispatchEvent(new MapboxHTMLEvent("suggest", result));
    }));
    __privateAdd(this, _handleSuggestError3, (error) => __async(this, null, function* () {
      __privateGet(this, _setActionIcons2).call(this);
      if (this.componentOptions.customSearch) {
        const customFeatures = yield this.componentOptions.customSearch(this.value);
        if (customFeatures && customFeatures.length) {
          ...
          __privateGet(this, _listbox3).handleSuggest(customFeatures || null);
        } else {
    ...
    __privateAdd(this, _handleRetrieve3, (result) => {
      ...
      if (this.componentOptions.flyTo) {
        __privateGet(this, _fly2).call(this, feature);
      }
      if (this.marker && this.mapboxgl) {
    ...
    __privateAdd(this, _onHandleInput3, (e) => {
      ...
      __privateGet(this, _session3).suggest(searchText, __spreadValues(__spreadValues({}, this.options), __privateGet(this, _getCoreComponentOptions2).call(this)));
    ...
    __privateAdd(this, _onHandleFocusOut2, (event) => {
      if (!__privateGet(this, _binding6).Geocoder.contains(event.relatedTarget) && !__privateGet(this, _listbox3).contains(event.relatedTarget)) {
        __privateGet(this, _onHandleBlur3).call(this);
        __privateGet(this, _listbox3).hideResults();
        this.dispatchEvent(new MapboxHTMLEvent("blur"));
      }
    });
    ...
    __privateAdd(this, _fly2, (feature) => {
      const map = __privateGet(this, _map2);
      if (!map) {
        return;
      }
      ...
      const bounds = feature.properties.bbox;
      if (bounds) {
        flyToOptions = bboxViewport(map, import_search_js_core10.LngLatBounds.convert(bounds).toFlatArray());
      } else {
        const center = feature.geometry.coordinates;
        const zoom = getMaxZoom(placeType);
        flyToOptions = {
  ...
  get componentOptions() {
    return __privateGet(this, _componentOptions2);
  }
  set componentOptions(options) {
    __privateSet(this, _componentOptions2, __spreadValues(__spreadValues({}, DEFAULT_COMPONENT_OPTIONS2), options));
  }
  get theme() {
  ...
  connectedCallback() {
    ...
    this.theme = __spreadValues({}, this.theme);
    const { Input, ClearBtn, Geocoder } = __privateGet(this, _binding6);
    Geocoder.addEventListener("focusout", __privateGet(this, _onHandleFocusOut2));
  ...
  disconnectedCallback() {
    const { Geocoder } = __privateGet(this, _binding6);
    Geocoder.removeEventListener("focusout", __privateGet(this, _onHandleFocusOut2));
...
_componentOptions2 = new WeakMap();
_getCoreComponentOptions2 = new WeakMap();
...
_onHandleFocusOut2 = new WeakMap();
...
var MapboxAddressMinimap = class extends HTMLScopedElement {
  ...
  connectedCallback() {
    ...
    this.theme = __spreadValues({}, this.theme);
    if (__privateGet(this, _canAdjustMarkerInternal) && !__privateGet(this, _binding7).EditButtons) {
      __privateGet(this, _addMarkerEditControls).call(this);
    }
    if (__privateGet(this, _satelliteToggleInternal) && !__privateGet(this, _binding7).MapStyleToggle) {
...
var _input4, _collection, _session4, _autofillCoreRef, _eventManager4, _initialAutocompleteValue2, _onHandleInput4, _onHandleSelect4, _onHandleBlur4, _onHandleInputBlur2, _onHandleFocus2, _handleClear4, _handleSuggest4, _handleSuggestError4, _handleRetrieve4;
var AddressAutofillInstance = class {
  constructor(collection, input, autofillRef) {
    ...
    __privateAdd(this, _onHandleInputBlur2, (event) => {
      if (!this.listbox.contains(event.relatedTarget)) {
        __privateGet(this, _onHandleBlur4).call(this);
    ...
    __privateGet(this, _input4).addEventListener("blur", __privateGet(this, _onHandleInputBlur2));
  ...
  remove() {
    this.listbox.remove();
    __privateGet(this, _input4).removeEventListener("blur", __privateGet(this, _onHandleInputBlur2));
...
_onHandleInputBlur2 = new WeakMap();
