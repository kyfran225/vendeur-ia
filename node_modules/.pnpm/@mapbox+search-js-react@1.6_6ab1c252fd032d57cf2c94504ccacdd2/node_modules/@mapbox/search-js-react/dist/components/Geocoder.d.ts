...
import { MapboxGeocoder, MapboxGeocoderComponentOptions, Theme, PopoverOptions, MapInstance } from '@mapbox/search-js-web';
declare global {
    namespace JSX {
 ...
 * ```
 */
export declare const Geocoder: React.ForwardRefExoticComponent<GeocoderProps & React.RefAttributes<GeocoderRefType>>;
