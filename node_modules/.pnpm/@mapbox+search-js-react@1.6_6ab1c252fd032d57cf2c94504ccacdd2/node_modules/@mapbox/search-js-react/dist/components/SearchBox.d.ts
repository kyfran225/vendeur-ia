...
import { MapboxSearchBox, MapboxSearchBoxComponentOptions, Theme, PopoverOptions, MapInstance } from '@mapbox/search-js-web';
declare global {
    namespace JSX {
 ...
 * ```
 */
export declare const SearchBox: React.ForwardRefExoticComponent<SearchBoxProps & React.RefAttributes<SearchBoxRefType>>;
